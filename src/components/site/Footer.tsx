    ...
    <footer className="mt-24 border-t border-border/60 bg-gradient-to-b from-transparent to-secondary/40">
      <div className="mx-auto max-w-7xl px-4 py-14 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-1">
          <div className="flex items-center gap-2 font-bold text-lg">
            <img src={logoAsset} alt="Reddy Pharma" className="h-12 w-auto rounded-xl object-contain" />
            {SITE.name}
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/request" className="hover:text-primary">Request Medicine</Link></li>
      ...
      <div className="border-t border-border/60 py-5 text-center text-xs text-muted-foreground">
        © {new Date().getFullYear()} {SITE.name}. All rights reserved.   
              built by <a href="https://www.webpagixsolutions.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary">webpagixsolutions</a>
      </div>
    </footer>
  );
}
