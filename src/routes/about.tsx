...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Reddy Pharma" },
      {
        name: "description",
        content:
          "Family-run pharmacy serving Bengaluru with genuine medicines and personal care for over 15 years.",
      },
      { property: "og:title", content: "About — Reddy Pharma" },
...
const founderImage = "src/assets/founder.png";
const shopImage = "src/assets/shop.jpg";
        ...
        >
          ...
          <div className="relative z-10 text-center px-6 text-white">
            ...
            <p className="mt-5 max-w-2xl mx-auto text-white/90 text-lg">
              Serving families with genuine medicines, trusted advice,
              and compassionate care for over 7 years.
            </p>
          </div>
        </div>
        ...
        >
            ...
            <div className="mt-6 grid md:grid-cols-[220px_1fr] gap-8 items-center">
              ...
              <div>
                <p className="text-muted-foreground leading-relaxed">
                  Reddy Pharmacy started as a small neighbourhood shop
                  with a simple mission — make quality healthcare easy
                  and trustworthy for every family in Bengaluru. Over a
                  decade later, that mission is still the heart of
                  everything we do.
                </p>

                <div className="mt-5">
                  <h3 className="font-semibold text-lg">
                    Mr. Vishnu Reddy, Founder
                  </h3>

                  <p className="mt-2 text-sm text-muted-foreground">
                    "Our goal has always been simple: provide genuine
                    medicines, honest guidance, and care that every
                    family can rely on."
                  </p>
                </div>
              </div>
          ...
          <div>
            ...
            <p className="mt-3 text-muted-foreground leading-relaxed">
              To deliver genuine medicines, honest advice, and friendly
              service — quickly, every single time. From a paracetamol
              pickup to managing chronic care, we're here for every
          ...
          <div>
            ...
            <p className="mt-3 text-muted-foreground leading-relaxed">
              Thousands of families, doctors, and clinics rely on us
              because we never compromise on authenticity, we answer
              the phone, and we go the extra mile to make healthcare
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {VALUES.map((v, i) => (
              <motion.div
                ...
                className="rounded-2xl p-6 bg-card border border-border/60 shadow-card"
              >
