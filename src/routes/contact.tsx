...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Reddy Pharmacy" },
      { name: "description", content: "Call, WhatsApp, email or visit Reddy Pharmacy in Bengaluru. We're here to help." },
      { property: "og:title", content: "Contact — Reddy Pharmacy" },
...
function ContactPage() {
  const items = [
    ...
    { icon: MessageCircle, label: "WhatsApp", value: SITE.phone, href: waLink("Hi! I have a question.") },
    ...
    <SiteLayout>
      <Section>
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-3 text-muted-foreground">Reach us any way you like — we usually reply within minutes.</p>
        </div>
        ...
        <div className="mt-12 grid lg:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Button asChild size="lg" className="rounded-full bg-gradient-to-r from-primary to-primary-glow shadow-sog h-12 px-6">
                <a href={waLink("Hi! I'd like to order medicines.")} target="_blank" rel="noopener noreferrer">WhatsApp Us</a>
              </Button>
